...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uiMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		hr = CoCreateInstance(CLSID_CSumSubract, NULL, CLSCTX_INPROC_SERVER, IID_ISum, (void**)&pISum);
		...
		pISum->SumOfTwoIntergers(iNum1, iNum2, &iResult);
		...
		pISubtract->SubtractionOfTwoIntergers(iNum1, iNum2, &iResult);
