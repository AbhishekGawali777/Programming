            ...
            switch(event.type)
            {
                ...
                case KeyPress:      // WM_KEYDOWN
                    ...
                    switch(keysym)
                    {
                        ...
                        case XK_0:
                        case XK_KP_0: // KP : KeyPad
                            glViewport(0, 0, (GLsizei)iWinWidth, (GLsizei)iWinHeight);
                            break;
                            
                        case XK_1:
                        case XK_KP_1:
                            glViewport(0, (GLsizei)iWinHeight / 2, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2);
                            break;
                       
                             
                        case XK_2:
                        case XK_KP_2:
                            glViewport((GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2);
                            break;
                       
                        case XK_3:
                        case XK_KP_3:
                            glViewport((GLsizei)iWinWidth / 2, 0, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2);
                            break;
                        
                        case XK_4:
                        case XK_KP_4:
                            glViewport(0, 0, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2);
                            break;
                        
                        case XK_5:
                        case XK_KP_5:
                            glViewport(0, 0, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight);
                            break;
                        
                        case XK_6:
                        case XK_KP_6:
                            glViewport((GLsizei)iWinWidth/ 2, 0, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight);
                            break;
                        
                        case XK_7:
                        case XK_KP_7:
                            glViewport(0, (GLsizei)iWinHeight / 2, (GLsizei)iWinWidth, (GLsizei)iWinHeight / 2);
                            break;
                        
                        case XK_8:
                        case XK_KP_8:
                            glViewport(0, 0, (GLsizei)iWinWidth, (GLsizei)iWinHeight / 2);
                            break;
                        
                        case XK_9:
                        case XK_KP_9:
                            glViewport((GLsizei)iWinWidth / 4, (GLsizei)iWinHeight / 4, (GLsizei)iWinWidth / 2, (GLsizei)iWinHeight / 2);
                            break;
