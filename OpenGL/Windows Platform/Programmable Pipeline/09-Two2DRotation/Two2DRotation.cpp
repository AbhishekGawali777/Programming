...
void Initialize(void)
{
	...
	glVertexAttribPointer(ABG_ATTRIBUTE_COLOR, 3, GL_FLOAT, GL_FALSE, 0, NULL);
...
void Display()
{
	...
	modelViewMatrix = vmath::translate(1.5f, 0.0f, -6.0f) * vmath::rotate(gRotateAngle_Square, 0.0f, 1.0f, 0.0f);;
