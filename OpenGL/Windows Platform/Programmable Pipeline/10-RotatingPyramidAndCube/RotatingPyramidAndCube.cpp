...
#include"RotatingPyramidAndCube.h"
#include"vmath.h"
...
GLfloat gRotateAngle_Triangle = 0.0f;
...
void Initialize(void)
{
	...
	glBindAttribLocation(gShaderProgramObject, ABG_ATTRIBUTE_COLOR, "vColor");
	...
	GLfloat fZero = 0.0f;
	GLfloat fPyramidColor = 1.0f;
	GLfloat fCubeColor = 1.0f;
	...
	{
		//Front
		fPyramidColor, fZero, fZero, fPyramidColor, //apex
		fZero, fPyramidColor, fZero, fPyramidColor, //left-bottom
		fZero, fZero, fPyramidColor, fPyramidColor, //right bottom

		//Right
		fZero, fZero, fPyramidColor, fPyramidColor, //apex
		fPyramidColor, fZero, fZero, fPyramidColor, //left-bottom
		fZero, fPyramidColor, fZero, fPyramidColor, //right bottom

		//Back
		fZero, fPyramidColor, fZero, fPyramidColor, //apex
		fZero, fZero, fPyramidColor, fPyramidColor, //left-bottom
		fPyramidColor, fZero, fZero, fPyramidColor, //right bottom
	...
	{
		//Front
		fCubeColor,fZero,fZero,fCubeColor,
		fCubeColor,fZero,fZero,fCubeColor,
		fCubeColor,fZero,fZero,fCubeColor,
		fCubeColor,fZero,fZero,fCubeColor,

		//Back
		fZero,fZero,fCubeColor,fCubeColor,
		fZero,fZero,fCubeColor,fCubeColor,
		fZero,fZero,fCubeColor,fCubeColor,
		fZero,fZero,fCubeColor,fCubeColor,

		//Right
		fZero,fCubeColor,fZero,fCubeColor,
		fZero,fCubeColor,fZero,fCubeColor,
		fZero,fCubeColor,fZero,fCubeColor,
		fZero,fCubeColor,fZero,fCubeColor,
		...
		//Top
		fCubeColor,fZero,fCubeColor,fCubeColor,
		fCubeColor,fZero,fCubeColor,fCubeColor,
		fCubeColor,fZero,fCubeColor,fCubeColor,
		fCubeColor,fZero,fCubeColor,fCubeColor,

		//Bottom
		fCubeColor,fCubeColor,fZero,fCubeColor,
		fCubeColor,fCubeColor,fZero,fCubeColor,
		fCubeColor,fCubeColor,fZero,fCubeColor,
		fCubeColor,fCubeColor,fZero,fCubeColor,
	};
	...
	glVertexAttribPointer(ABG_ATTRIBUTE_COLOR, 4, GL_FLOAT, GL_FALSE, 0, NULL);
	glEnableVertexAttribArray(ABG_ATTRIBUTE_COLOR);
	glBindBuffer(GL_ARRAY_BUFFER, 0);
...
void Display()
{
	...
	modelViewMatrix = vmath::translate(-1.5f, 0.0f, -6.0f) * vmath::rotate(gRotateAngle_Triangle, 0.0f, 1.0f, 0.0f);
	...
	modelViewMatrix = vmath::translate(1.5f, 0.0f, -6.0f) * vmath::rotate(gRotateAngle_Square, 1.0f, 0.0f, 0.0f);;
	modelViewMatrix = modelViewMatrix * vmath::rotate(gRotateAngle_Triangle, 0.0f, 1.0f, 0.0f);
	modelViewMatrix = modelViewMatrix * vmath::rotate(gRotateAngle_Triangle, 0.0f, 0.0f, 1.0f); 
	...
	gRotateAngle_Square = Update(gRotateAngle_Square);
	gRotateAngle_Triangle = Update(gRotateAngle_Triangle);
}
