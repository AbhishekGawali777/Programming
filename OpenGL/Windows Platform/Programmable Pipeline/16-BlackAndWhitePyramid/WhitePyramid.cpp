...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int nCmdShow)
{
	...
	WNDCLASSEX	WndClass;
	bool		bDone = false;
	TCHAR		szAppName[] = { TEXT("WhitePyramidWindow") };
...
// Log File Creation
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Lights : Spining White Pyramid"),
...
void Display()
{
	...
	modelViewMatrix = vmath::translate(0.0f, 0.0f, -6.0f) * vmath::rotate(gRotateAngle_Triangle, 0.0f, 1.0f, 0.0f);
