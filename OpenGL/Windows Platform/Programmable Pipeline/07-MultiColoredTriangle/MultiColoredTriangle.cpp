...
#include"MultiColoredTriangle.h"
#include"vmath.h"
...
void Initialize(void)
{
	...
	glGenVertexArrays(1, &gVao_Position);
	glBindVertexArray(gVao_Position);
...
void Uninitialize(void)
{
	...
	if (gVao_Position)
	{
		glDeleteVertexArrays(1, &gVao_Position);
		gVao_Position = 0;
	}
