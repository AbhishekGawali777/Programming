...
void ToggleFullScreen(void)
{
	...
	if (gbFullScreen == false)
	{
		...
		// Checking the bit of  style which we have got with WM_OVERLAPPEDWINDOW is true or not.
		...
		//	if (GetWindowPlacement(ghwnd, &wpPrev) && GetMonitorInfo(MonitorFromWindow(ghwnd, MONITOR_DEFAULTTOPRIMARY), &mi))
			...
			{
				// ~ does all 0 bits to 1 and vice versa i.e., 1's Complement
				
				//SetWindowLong(HANDLE, oldstyle, Setting new style of window);
