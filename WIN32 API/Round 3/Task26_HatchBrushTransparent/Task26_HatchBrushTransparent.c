...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		hBrush = (HBRUSH)SelectObject(hdc,CreateHatchBrush(BS_PATTERN, RGB(255, 60, 4)));
		...
		hBrush = (HBRUSH)SelectObject(hdc,CreateHatchBrush(BS_DIBPATTERN, RGB(255, 45, 68)));

		Ellipse(hdc, cxClient / 8, cyClient / 8, 7 * cxClient / 8, 7 * cyClient / 8);
		
		hBrush = (HBRUSH)SelectObject(hdc,CreateHatchBrush(BS_SOLID, RGB(0, 255, 0)));
