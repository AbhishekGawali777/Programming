					...
					)
{
	...
	case WM_PAINT:
		...
		TextOut(hdc, rcClient.left, rcClient.bottom, TEXT("Hello Win32 Developers...!!!"),(int)_tcslen(TEXT("Hello Win32 Developers")));
		//DrawText(hdc, TEXT("Hello Win32 Developers...!!!"),(int)_tcslen(TEXT("Hello Win32 Developers")),&rcClient,DT_CENTER|DT_VCENTER|DT_SINGLELINE);
